<template>
  ...
  <div class="app-header"> -->
    ...
    <t-tooltip content="连线">
      <svg width="1em" height="1em" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" @click="drawLine"
        :style="{ color: isDrawLine ? ' #1677ff' : '', }">
        <!-- TODO: path标签的参数 -->
        <path
...
// 需要改变fromArrow（js脚本中定义的响应式变量）的值
